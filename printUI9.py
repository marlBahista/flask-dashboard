# Automatically subtracts paper count after printing
# ✅ Low paper warning when below the threshold (e.g., 5 sheets left)
# ✅ Displays real-time paper count in UI
# ✅ Allows manual paper refilling with a button
